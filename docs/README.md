...
Welcome to the organized documentation for the Coding Agent Template project.
...
- **process/**: Project management and review docs
...
4. **Clear naming**: Use descriptive names and follow the existing naming convention
