# 📚 Coding Agent Template - Documentation Overview

This document provides an overview of the organized documentation for the Coding Agent Template project.

## 📋 Essential Root Files

These files are intentionally kept in the root directory for easy access:

- [README.md](README.md) - Main project overview and quick start
- [ROADMAP.md](ROADMAP.md) - Project roadmap and strategic planning
- [TESTING.md](TESTING.md) - Testing strategy and coverage
- [QUICK_START.md](QUICK_START.md) - 5-minute quick start guide
- [SETUP_COMPLETE.md](SETUP_COMPLETE.md) - Setup completion summary
- [AGENTS.md](AGENTS.md) - AI agent security guidelines
...
- [DOCKER_OSS_ROADMAP.md](docs/docker-oss/DOCKER_OSS_ROADMAP.md) - Timeline & deployment strategy
...
- [MIGRATION.md](docs/development/MIGRATION.md) - Migration guide
...
- [OLLAMA_QUICK_START.md](docs/general/OLLAMA_QUICK_START.md) - Ollama quick start
- [SKILLS_TOOLS_REFERENCES.md](docs/general/SKILLS_TOOLS_REFERENCES.md) - Skills and tools references
- [START_HERE.md](docs/general/START_HERE.md) - Getting started guide
- [WSL_PORT_FORWARDING.md](docs/general/WSL_PORT_FORWARDING.md) - WSL port forwarding

## 🗂️ Navigation

- For a complete index of all documentation, see [docs/INDEX.md](docs/INDEX.md)
- For project structure overview, see [docs/README.md](docs/README.md)

## 🆕 Adding New Documentation

When adding new documentation files:

1. **Root Files**: Only add to root if truly essential for all users
2. **Category Placement**: Place in the most appropriate category subdirectory
3. **Index Updates**: Update the relevant index files to include new documentation
4. **Naming Convention**: Use clear, descriptive names following existing patterns
