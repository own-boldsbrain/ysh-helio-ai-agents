...
describe('Load Testing: Production-like Scenarios', () => {
  ...
  bench('Simulate 10 concurrent users for 5 seconds', async () => {
    ...
    return results
  }, { time: 6000 }) // Adjust timeout for this benchmark

  bench('Simulate 50 concurrent users for 10 seconds', async () => {
    const config: LoadTestConfig = {
      concurrentUsers: 50,
      durationSeconds: 10,
      targetEndpoint: '/api/github/user' // Example endpoint
